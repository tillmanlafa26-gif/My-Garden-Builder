const ICONS = {
    ...
    flower: (
        <>
            ...
            <path d="M12 9c-2.8-1.2-3.7-4.1-1.4-5.5C12.4 2.4 14 4.2 13.2 7" />
            <path d="M15 10c1.2-2.8 4.1-3.7 5.5-1.4 1.1 1.8-.7 3.4-3.5 2.6" />
            <path d="M14 15c2.8 1.2 3.7 4.1 1.4 5.5-1.8 1.1-3.4-.7-2.6-3.5" />
            <path d="M9 14c-1.2 2.8-4.1 3.7-5.5 1.4C2.4 13.6 4.2 12 7 12.8" />
        </>
    ),
    fruit: (
        <>
            <path d="M12 8c-3.9-3.2-8-.9-8 3.2C4 16.4 7.3 20 12 20s8-3.6 8-8.8C20 7.1 15.9 4.8 12 8Z" />
            <path d="M12 8c0-3 1.6-5 4.5-5" />
            <path d="M12 6c-2.1 0-3.6-.9-4.5-2.7C9.6 2.9 11.1 3.8 12 6Z" />
        </>
    ),
    harvest: (
        <>
            <path d="M5 10h14l-1 10H6L5 10Z" />
            <path d="M8 10c0-3 1.4-5 4-6 2.6 1 4 3 4 6" />
            <path d="M9 14v2M12 14v2M15 14v2" />
        </>
    ),
    wifiOff: (
        <>
            <path d="M2 8.5A15.5 15.5 0 0 1 7.2 5.7" />
            <path d="M16.8 5.7A15.5 15.5 0 0 1 22 8.5" />
            <path d="M5 12a10.8 10.8 0 0 1 5.1-2.6" />
            <path d="M14.7 9.8A10.5 10.5 0 0 1 19 12" />
            <path d="M8.7 15.5A5.5 5.5 0 0 1 12 14.4c1.3 0 2.5.4 3.3 1.1" />
            <path d="M12 19h.01" />
            <path d="M3 3l18 18" />
        </>
    ),
