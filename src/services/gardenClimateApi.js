...
export async function getGardenClimateData(
    ...
    if (
        ...
        throw new Error(
            "You’re offline and local climate data has not been saved for this location yet. Enter your zone and frost dates manually or try again online."
        );
    }
    ...
    try {
        ...
        throw new Error(
            "Local climate data is temporarily unavailable. Enter your zone and frost dates manually or try again later."
        );
    }
}
