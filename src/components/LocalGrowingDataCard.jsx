    ...
    async function resolveClimateData(
        ...
        try {
            ...
            if (
                ...
                setMessage(
                    "Using saved local growing data because live climate data is unavailable. You can still edit the zone and frost dates manually."
                );
            ...
            */
            ...
            setMessage(
                navigator.onLine === false
                    ? "Your garden location was captured, but this location has no saved climate data yet. Enter your zone and frost dates manually, or try again when you are online."
